...
public class Permission extends PermissionEnum {
    ...
    public static final Permission COMMAND_ENDERCHEST_CLEAR = new Permission("world.clearenderchest", PermissionDefault.OP, "Allows clearing a player's enderchest in a specific world");
    ...
    public static final Permission COMMAND_AUTOREGENERATE = new Permission("world.autoregenerate", PermissionDefault.OP, "Sets if the player can set whether a world is regenerated on startup or not");
